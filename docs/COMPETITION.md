...
| Độ ổn định | [TC21 disconnect](../tests/FocusMate_Test/Evidence/TC21_Dis.mp4), [TC22 reconnect](../tests/FocusMate_Test/Evidence/TC22_Reconnect.mp4), [TC24 phiên 61 phút](../tests/FocusMate_Test/Evidence/TC24_KetThucPhienDongHo.mp4) |
...
`RECORDED_FUNCTIONAL_TEST` xác minh các kịch bản chức năng đã tài liệu hóa; không phải
