...
| Geometry classifier/calibration | `IMPLEMENTED` | `EXPERIMENTAL` | `VERIFIED_LOCAL` | 6 geometry state trong fixture chung; `FACE_MISSING`/`UNKNOWN` fail-closed tests; live 0,50/calibration 0,70 |
...
| Posture với ESP32-S3 + Galaxy Watch 5 Pro thật | `IN_PROGRESS` | `TARGET` | `UNVERIFIED` | Shadow web đã nhận `HEAD_DOWN` thật (`dy=0,167`, conf 0,86); BLE MTU 256/0 lỗi. Chưa đủ các state, APK 1.14 chưa cài, low-light và soak; [retest](../reports/2026-08-23-posture-geometry-retest.md) |
