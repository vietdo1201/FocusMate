...
Ngày kiểm chứng tài liệu: 2026-08-25. Ý nghĩa trạng thái xem [GOVERNANCE.md](GOVERNANCE.md).
...
| Yawn advisory (Face Landmarker) | `IMPLEMENTED` | `EXPERIMENTAL` | `VERIFIED_LOCAL` | Broker event V2 theo phiên, idempotent + dedupe Web/Watch 1,5 giây, checkpoint/outbox, bridge BLE Control/Observation và HTTP fallback; MAR + `jawOpen`, 3 lần/10 phút; chưa device accuracy/thermal/soak test |
