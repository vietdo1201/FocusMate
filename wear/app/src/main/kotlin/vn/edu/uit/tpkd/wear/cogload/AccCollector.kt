...
class AccCollector(
    ...
    fun start(sessionStartTimeMs: Long = System.currentTimeMillis()): Boolean {
        ...
        val acc = accelerometer?.let {
            sensorManager.registerListener(this, it, SAMPLE_PERIOD_MICROS, SENSOR_BATCH_LATENCY_MICROS)
        } ?: false
        val gyro = gyroscope?.let {
            sensorManager.registerListener(this, it, SAMPLE_PERIOD_MICROS, SENSOR_BATCH_LATENCY_MICROS)
        } ?: false
        gravitySensor?.let {
            orientationSensorRegistered = sensorManager.registerListener(
                this, it, ORIENTATION_PERIOD_MICROS, SENSOR_BATCH_LATENCY_MICROS,
            ) ||
    ...
    companion object {
        ...
        private const val ORIENTATION_PERIOD_MICROS = 200_000
        private const val SENSOR_BATCH_LATENCY_MICROS = 2_000_000
